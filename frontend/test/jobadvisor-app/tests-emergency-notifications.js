module.exports = {
  ...
  'Test notifications accepted': function (client) {
    client
      ...
      .assert.containsText('#usnt-590f2bcfda0f255fd9fb5654 #notification-profession', 'Profession Requested : Plumber')
      .assert.containsText('#usnt-590f2bcfda0f255fd9fb5654 #notification-description', 'Description : I want a plumber because my sink is broken')
      .assert.containsText('#usnt-590f2bcfda0f255fd9fb5654 #notification-phone', 'Phone number : 000000000')
      .assert.containsText('#usnt-590f2bcfda0f255fd9fb5654 #notification-location', 'Location : Via Monte Bre 16, Lugano')
      .assert.containsText('#usnt-590f2bcfda0f255fd9fb5654 #notification-status', 'Status : Pending')
      ...
      .assert.containsText('#flnt-590f2bcfda0f255fd9fb5654 #notification-profession', 'Profession Requested: Plumber')
      .assert.containsText('#flnt-590f2bcfda0f255fd9fb5654 #notification-description', 'Description : I want a plumber because my sink is broken')
      .assert.containsText('#flnt-590f2bcfda0f255fd9fb5654 #notification-status', 'Status : Pending')
      ...
      .refresh()
      .pause(500)
      .assert.containsText('#usnt-590f2bcfda0f255fd9fb5654 #notification-status', 'Status : Accepted')
      .end();
  },
